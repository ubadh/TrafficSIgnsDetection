...
vector<Mat> detectWarningSigns(Mat img, CascadeClassifier warning_cascade){
    Mat grayImg;
    ...
    // Detect the sign
    vector<Rect> signs;
    warning_cascade.detectMultiScale( grayImg, signs, 1.1, 3, 0|CASCADE_SCALE_IMAGE, Size(30, 30) );
    cout<<warning_cascade.getFeatureType()<<endl;
